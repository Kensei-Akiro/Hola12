        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Transforming businesses through innovative solutions and strategic insights.
            </p>
            <p className="text-gray-400">
              &copy; {new Date().getFullYear()} Innovate Inc. All rights reserved.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#team" className="text-gray-400 hover:text-blue-400 transition-colors">Team</a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-gray-400 hover:text-blue-400 transition-colors">Business Strategy</a>
              </li>
              <li>
              ...
              <li>
                <a href="#" className="text-gray-400 hover:text-blue-400 transition-colors">Data Analytics</a>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              Designed with ♥ for businesses that want to make a difference.
            </p>
